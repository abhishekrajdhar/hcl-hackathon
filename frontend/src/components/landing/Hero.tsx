...
export function Hero() {
  return (
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden">
      ...
      {/* Frame the viewport like an instrument, not a page. */}
      <Corners />

      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 pt-24 lg:px-12">
        <div className="max-w-2xl">
          ...
          <h1 className="display text-[44px] font-semibold leading-[0.98] sm:text-6xl lg:text-[76px]">
            Your knowledge
            <br />
            has a{" "}
          ...
          <p className="mt-7 max-w-lg text-[15px] leading-relaxed text-text-2">
      ...
      <div className="relative z-10 mx-auto mt-auto w-full max-w-[1400px] px-6 pb-8 pt-20 lg:px-12">
